...
const AVATAR_URL = 'https://www.meme-arsenal.com/memes/1033011a397fa71263c7f7ce4cfd7e78.jpg';
...
export class ChatNewComponent implements OnInit, AfterViewInit {
	...
	ioConnection: any;
	dialogRef: MatDialogRef<DialogUserComponent> | null | undefined;
	...
	@ViewChild(MatList, { read: ElementRef, static: true }) matList: ElementRef | undefined;

	// getting a reference to the items/messages within the list
	@ViewChildren(MatListItem, { read: ElementRef }) matListItems: QueryList<MatListItem> | undefined;
